...
* Viscous dissipation -- :math:`\Phi_k=\int_{\Omega_k}\boldsymbol{\varepsilon} : \nabla \mathbf{u} dV`
...
dissipation function is determined based on the viscous stress tensor, denoted by :math:`\boldsymbol{\varepsilon}`.
