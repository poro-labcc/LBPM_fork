...
In this analysis, our aim is to observe the dependence between the viscosity, represented
by the relaxation time of the collision model (:math:`\tau`), and the absolute permeability 
(:math:`k`). This dependence is well-known in lattice Boltzmann literature and can be addressed 
